                                                 ...
                                                 const bool verbose)
{
 ...
 //   cv::waitKey();
    ...
    cv::Mat mask;
    cv::Mat world_coordinate = Ms7ScenesUtil::camera_depth_to_world_coordinate(camera_depth_img, pose, mask);
                                                 ...
                                                 const bool verbose)
{
    ...
    cv::Mat world_coordinate =  Ms7ScenesUtil::cameraDepthToWorldCoordinate(camera_depth_img, pose, calibration_matrix, depth_factor, min_depth, max_depth, camera_coordinate, mask);
...
bool RGBGUtil::readDatasetParameter(const char *file_name, DatasetParameter & dataset_param)
{
    ...
    dataset_param.depth_factor_= imap[string("depth_factor")];
    dataset_param.k_focal_length_x_= imap[string("k_focal_length_x")];
    dataset_param.k_focal_length_y_= imap[string("k_focal_length_y")];
    dataset_param.k_camera_centre_u_= imap[string("k_camera_centre_u")];
    dataset_param.k_camera_centre_v_= imap[string("k_camera_centre_v")];
